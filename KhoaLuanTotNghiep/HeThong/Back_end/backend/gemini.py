...
async def grade_essay_from_pdf(pdf_path, essay_title, selected_criteria_ids=None, temp=0.7):
    ...
    prompt = f"""
    Bạn là một giáo viên có thể chấm điểm nhiều môn học. Hãy chấm điểm bài tự luận sau theo thang điểm 10, dựa trên các tiêu chí được cung cấp.
    ...
    "phù_hợp": "[Có/Không]",
    "điểm_tổng": "[Số điểm]",
    "giải_thích_chung": "[Giải thích tổng quan]",
    {criteria_results}
    }}
    """
